...
The application follows Clean Architecture principles divided into 3 distinct layers:

1. **Data Layer (`lib/data/`):**
   - `Product` & `ProductResponse` JSON serialization models.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/adinkz03/neurogine-product-catalog.git](https://github.com/adinkz03/neurogine-product-catalog.git)
